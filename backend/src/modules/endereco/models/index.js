...
class EnderecoModel{
    static async criarEndereco(cep, numero, ponto_referencia){
        ...
        const consulta = `ISERT into profissional_endereco(id_profissional, cep, logradouro, numero, complemento, bairro, localidade, uf, ponto_referencia) value ($1, $2, $3, $4, $5, $6, $7, $8, $9) returning *`
        const resultado = await pool.query(consulta, dados)
        return resultado.rows
    }

    static async editarEndereco(id_profissional, cep, numero, ponto_referencia){
